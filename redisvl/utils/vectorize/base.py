...
class BaseMultimodalVectorizer(BaseModel, ABC):
    """Base vectorizer interface."""
    ...
    def embed(
        ...
        **kwargs,
        ...
        Args:
            content: The content to embed. It is s alist of texts or Images
            preprocess: Optional function to preprocess text
            as_buffer: If True, returns a bytes object instead of a list
    ...
    async def aembed_many(
        ...
        **kwargs,
        ...
        """
        # Fallback to standard embedding call if no async support
        return self.embed_many(contents, preprocess, batch_size, as_buffer, **kwargs)
    ...
    async def aembed(
        ...
        **kwargs,
        ...
        """
        # Fallback to standard embedding call if no async support
        return self.embed(content, preprocess, as_buffer, **kwargs)
