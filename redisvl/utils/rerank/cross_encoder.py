...
class CrossEncoderReranker(BaseReranker):
    """
    The CrossEncoderReranker class uses a cross-encoder models from Hugging Face
    ...
    .. code-block:: python
        ...
        from redisvl.utils.rerank import CrossEncoderReranker

        # set up the CrossEncoderReranker with a specific model
        reranker = CrossEncoderReranker(model_name="cross-encoder/ms-marco-MiniLM-L-6-v2", limit=3)
    ...
    def __init__(
        ...
        """
        Initialize the CrossEncoderReranker with a specified model and ranking criteria.
