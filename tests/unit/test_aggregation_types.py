...
def test_aggregate_hybrid_query_search_window_size():
    ...
    # Check params dictionary
    assert query.params.get("SEARCH_WINDOW_SIZE") == 40


def test_aggregate_hybrid_query_use_search_history():
    """Test that AggregateHybridQuery correctly handles use_search_history parameter (SVS-VAMANA)."""
    for value in ["OFF", "ON", "AUTO"]:
        ...
        # Check properties
        assert query._use_search_history == value
        ...
        # Check params dictionary
        assert query.params.get("USE_SEARCH_HISTORY") == value


def test_aggregate_hybrid_query_search_buffer_capacity():
    """Test that AggregateHybridQuery correctly handles search_buffer_capacity parameter (SVS-VAMANA)."""
    query = AggregateHybridQuery(
        text=sample_text,
        text_field_name="description",
        vector=sample_vector,
    ...
    # Check params dictionary
    assert query.params.get("SEARCH_BUFFER_CAPACITY") == 50


def test_aggregate_hybrid_query_all_runtime_params():
    """Test AggregateHybridQuery with all runtime parameters combined."""
    query = AggregateHybridQuery(
        text=sample_text,
        text_field_name="description",
        vector=sample_vector,
